...
class CausalSelfAttention(nn.Module):
    def __init__(self, dim: int, num_heads: int, layer_idx: int):
        ...
        # Use half the number of heads for diff attention
        ...
        # Initialize lambda parameters for diff attention
        ...
        # Keep existing rotary implementation
    ...
    def forward(self, x: Tensor, ve: Tensor | None):
        ...
        # Regular attention instead of FlexAttention
        ...
        # Reshape for diff attention
        q = q.view(B, T, self.num_heads, 2, self.head_dim)
        k = k.view(B, T, self.num_heads, 2, self.head_dim)
        ...
        # Calculate lambda weights and combine attention streams
        ...
        # Combine attention streams with diff mechanism
