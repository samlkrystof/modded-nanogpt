...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x: Tensor, ve: Tensor | None):
        ...
        # Project and reshape QKV in one operation
        qkv = self.qkv_proj(x).reshape(B, T, 3, self.num_heads, -1)
        
        # More efficient splitting and transposing
        q, k, v = qkv.unbind(dim=2)  # Split along dim 2 (the '3' dimension)
        ...
        # Use scaled_dot_product_attention with is_causal=True
